...
**hello_rails_react** is app build using ruby on rails ([rails-repo](https://github.com/enis-memic/hello-rails-back-end)) and react
...
Feel free to check the [issues page](https://github.com/enis-memic/hello-rails-back-end/issues).
